      ...
      <div className="bg-backgroundColor w-[1000px] items-center h-full">
        ...
        <div className="items-center  w-full mt-4">
          <div className="flex items-center flex-col">
            {" "}
            <div className="inline-flex  justify-center text-orange-600 bg-[#422D24] px-4 py-1.5 rounded-[20px] mb-7">
              <div className="pr-[6px]">0xc73cc...cdE73</div>
              <i className="wallet-coin-address-copy fa-regular fa-copy "></i>
            </div>
            <div className="mb-8 text-[36px] items-center flex">
              0 SepoliaETH
            </div>
          </div>

          <div className=" mb-8  w-full flex items-center justify-center ">
            {/* <div className="w-20  flex-col flex items-center justify-between">
              <div className="mb-2.5 bg-orange-600 w-10 h-10 rounded-full  opacity-1 flex items-center justify-center">
        ...
        <div className="wallet-container-activity">
          <div className="shadow-md py-4 px-6 relative flex items-center justify-center">
            <div className=" w-1/3 pb-2.5 ">Chain Analytics</div>
            <div className="w-1/3 pb-2.5 border-b-2 border-orangered mr-5 ">
              Tokens
            </div>
            <div className="w-1/3 pb-2.5">Activitys</div>
          </div>
          <div className="mx-5 my-5 text-red-500 text-left px-3 text-lg font-semibold flex justify-center ">
            <div className="wallet-activity-refresh-list border-[1px] px-3  py-2 rounded-3xl border-red-500 ">
          ...
          <div className="mb-[20px] ">
            ...
            <div className="flex px-4 py-3 ">
              <img
                ...
                className="h-10 w-10 mr-4 rounded-[50px]"
              />
              <div className="justify-start flex-col flex">
                <div className="font-bold pb-[6px]">MyToken</div>
                <div className="wallet-token-item-real-balance">20 MyToken</div>
              </div>
            </div>
